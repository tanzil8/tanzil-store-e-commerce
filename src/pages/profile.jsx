...
const imageList = ref(storage, 'image/')


function hendlinguploadimg() {
...
<div class="w-full py-9 bg-gray-50 rounded-2xl border border-gray-300 gap-3 grid border-dashed">
      ...
      <button onClick={hendlinguploadimg} type="button" class="max-w-[140px] py-2 px-4 flex justify-center items-center bg-indigo-600 hover:bg-indigo-600 focus:bg-indigo-800 focus:ring-offset-red-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
...
<button type="button" class= " w-60 mt-10 ml-7 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Remove Profile </button>
</div>
      </div>
     </>
    )
